...
class Movie{
  ...
  public static function fetchMoviesFromDatabase($conn){
    ...
    if($conn){
      ...
      $movies = Movie::fetchDefaultMovies();
    return $movies;
  }

  public static function fetchDefaultMovies(){
    $movies = [];
    $movies[] = new Movie(1,"Il Padrino","The Godfather","en","1972-03-24",9.2,"https://www.themoviedb.org/t/p/w600_and_h900_bestv2/r4gnMXoY1efvaolNDjn3nj4046S.jpg");
    $movies[] = new Movie(2,"Via Col Vento","Gone With The Wind","en","1939-12-15",8.6,"https://www.themoviedb.org/t/p/w300_and_h450_bestv2/xRyW60TXvX7Q2HSbpz8nZxKaTkL.jpg");
    $movies[] = new Movie(3,"Psycho","Psycho","en","1960-06-16",9.4,"https://www.themoviedb.org/t/p/w600_and_h900_bestv2/tdqX0MWaFHuGwUygYn7j6eluOdP.jpg");
    return $movies;
  }
